 ...
 */
export function requestDisclosure({requested = ['inversionista'/*'name','phone','avatar','country','email'*/], verified}) {
  ...
  uport.onResponse(DISCLOSURE_REQUEST).then(profile => {
    ...
    claim : {
      "inversionista": {
        "nombre": "Oscar Quisbert",
        "sexo": "Masculino",
        "edad" : 60,
        "conocimientoDeInversionista" : "alto",
        "tipoUltimaInversion":"inter",
        "fechaUltimaInversion" : "23/11/2018",
        "ingresoMensual":"fijo",
        "ingresoFamiliar": 25
         }
        }
    ...
    /*claim : {
          "operacion3": {
            "instrumento": "Acciones Preferentes",
            "tasa": "1%",
            "fecha" : "23/11/2018",
            "renta" : "Variable"
              }
