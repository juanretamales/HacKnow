...
import fondocert from '../../assets/img/fondocert.png'
const Dashboard = ({authData}) => {
  ...
  var d = new Date();
  var diaExp = d.getDay()
  var mesExp = d.getMonth()+1
  var anoExp = d.getDate()
    ...
    <div class="aurora-outer">
      <div class="aurora-inner">
        ...
        <div class="cert">
          ...
          <h2>{ inversionista['nombre']}</h2>
          <p> Inversionista clasificado como usuario del tipo <strong>{ sco_edad }</strong>, este documento expira el día { diaExp }-{ mesExp }-{ anoExp }.</p>
          <img id="fondocert" alt="logo" src={fondocert}/>
          </div>
        </div>
